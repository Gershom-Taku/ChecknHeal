...
#-----------------------------------------------------------------------------------------------------
 if bio == 'Self Test Page🩺':
    ...
    diabetes_model = pickle.load(open(r'C:\Users\ADMIN\Desktop\thesis1\diabetes_model.sav','rb'))

    heart_disease_model = pickle.load(open(r'C:\Users\ADMIN\Desktop\thesis1\heart_disease_model.sav','rb'))

    parkinsons_model = pickle.load(open(r'C:\Users\ADMIN\Desktop\thesis1\parkinsons_model.sav','rb'))
